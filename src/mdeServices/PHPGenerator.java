...
/**
 *  Main Class for generating the PHP application 
 * 
...
public abstract class PHPGenerator extends MDEServices{


	public void generate(File input, String importFromTool, File output, String user) throws ImportXMIException, JDOMException,IOException,PHPGenerationException, TransformationNotApplicable, FileNotFoundException
	{
	...
	public void generate(Project p, File output, String user) throws ImportXMIException, JDOMException,IOException,PHPGenerationException, TransformationNotApplicable, FileNotFoundException
	{
		//If not yet done, initializing the language resource and properties
		if (o==null || l==null)
		{
	...
	protected abstract void generateScripts(Project p, File output, String user) throws ImportXMIException, JDOMException,IOException,PHPGenerationException, TransformationNotApplicable, FileNotFoundException;
