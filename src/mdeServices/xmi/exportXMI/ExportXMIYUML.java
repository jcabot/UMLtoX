 ...
 *
 */
public class ExportXMIYUML extends ExportXMI{

	public ExportXMIYUML() {super();}
	...
	{
		//Just the URL prefix to visualize the diagram online
		out.print("http://yuml.me/diagram/class/");
	};
