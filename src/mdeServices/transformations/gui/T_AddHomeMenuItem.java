...
public class T_AddHomeMenuItem extends Transformation {
	 ...
	 */
	public T_AddHomeMenuItem(Project p, Options o) {
		super(p, o);
	}
	 ...
	 * @throws TransformationNotApplicable
	 */
	public T_AddHomeMenuItem(Project p, Options o, LangManager l)
	{
		super(p, o,l);
	}
	...
	public void exec() throws TransformationNotApplicable {
		...
		MenuItem mi=new MenuItem(l.getString("app.caption.menu.item.home"));
		mi.setDestination(p.getDynamicModel().getInitialForm());
		mi.setCaption(l.getString("app.caption.menu.item.home"));
